...
Source0  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.44.tar.gz
Source1  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.44.tar.gz.sig
...
%setup -q -n mtools-4.0.44
cd %{_builddir}/mtools-4.0.44
pushd ..
cp -a mtools-4.0.44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717430589
