...
Version  : 4.0.47
Release  : 29
URL      : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.47.tar.gz
Source0  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.47.tar.gz
Source1  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.47.tar.gz.sig
...
%setup -q -n mtools-4.0.47
cd %{_builddir}/mtools-4.0.47
pushd ..
cp -a mtools-4.0.47 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737388468
