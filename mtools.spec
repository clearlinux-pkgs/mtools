...
Version  : 4.0.45
Release  : 27
URL      : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.45.tar.gz
Source0  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.45.tar.gz
Source1  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.45.tar.gz.sig
...
%setup -q -n mtools-4.0.45
cd %{_builddir}/mtools-4.0.45
pushd ..
cp -a mtools-4.0.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727541799
