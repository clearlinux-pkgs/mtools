...
Source0  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.41.tar.gz
Source1  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.41.tar.gz.sig
...
%prep
%setup -q -n mtools-4.0.41
cd %{_builddir}/mtools-4.0.41
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663599011
