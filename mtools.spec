...
Source0  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.48.tar.gz
Source1  : https://mirrors.kernel.org/gnu/mtools/mtools-4.0.48.tar.gz.sig
...
%setup -q -n mtools-4.0.48
cd %{_builddir}/mtools-4.0.48
pushd ..
cp -a mtools-4.0.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740411174
